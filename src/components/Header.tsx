...
export default function Header() {
  ...
  return (
    <header
      className="sticky top-0 z-50 backdrop-blur-sm border-b border-amber-100"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="relative flex items-center justify-between h-16 sm:h-20 md:h-24">
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden text-gray-700 hover:text-amber-800 transition-colors z-10"
            onClick={toggleMenu}
        ...
        >
          <nav className="py-4 space-y-3 border-t border-amber-100">
            <a
              href="#services"
              className="block px-4 py-2 text-gray-700 hover:text-amber-800 hover:bg-amber-50 transition-colors rounded"
              onClick={closeMenu}
            >
              Services
            </a>
            ...
            <div className="flex items-center space-x-4 px-4 pt-2 border-t border-amber-100">
              <a
                href="#"
                className="text-gray-600 hover:text-amber-800 transition-colors"
                aria-label="Instagram"
